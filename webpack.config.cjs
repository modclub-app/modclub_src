...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.EnvironmentPlugin({
      ...
      ARCHIVE_CANISTER_ID: canisters["archive"] || "aaaaa-aa",
      ARCHIVE_DEV_CANISTER_ID: canisters["archive_dev"] || "aaaaa-aa",
      ARCHIVE_QA_CANISTER_ID: canisters["archive_qa"] || "aaaaa-aa",
      LOCAL_II_CANISTER,
