...
module {
  ...
  private func getLogMessagesInfo(state : TypesModule.State) : ?TypesModule.CanisterLogMessagesInfo {
    ...
    let features : [?TypesModule.CanisterLogFeature] = [
  ...
  private func iterateLogMessagesInt(
    state : TypesModule.State,
    reverse : Bool,
  ...
  private func testChunkLogMessages() {
    ...
    CollectorModule.storeLogMessage(state, "4 message", 3, 3);
    // check same nanos!!! 3 must be stored as 4!
