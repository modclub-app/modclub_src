  ...
  const onPurchase = async () => {
    switch (walletInUse) {
      case "stoic":
        ...
        const accountToTransferTo =
          await ICpch.getCanisterDefaultAccountIdentifier()
        transferUsingStoic(
          principalInUse,
          "53e271eb078f00f27600992c3237cbd783d9ad95a56dd700b42a2601056d0006",
          "0.0001",
          "0.0001",
        )
  ...
  const transferUsingStoic = async (principal, accoutOfToUser, amount, fee) => {
    ...
    if (!id)
      return console.error(
        "Something wrong with your wallet, try logging in again",
      )
      ...
      {isConnected ? (
        <>
          ...
          <button
            ...
            onClick={onPurchase}
            disabled={currentTransactionStage > 0}
          >
