...
const asset_entry = path.join("src", "vc_rust", "app", "index.html");
...
module.exports = {
  ...
  output: {
    filename: "[name].js",
    path: path.join(ROOT_DIR, "dist", "vc_rust"),
  ...
  module: {
    rules: [
      ...
      {
        test: /\.(sa|sc|c)ss$/,
        include: path.resolve(ROOT_DIR, "src/vc_rust/app"),
        use: [
      ...
      },
      {
        ...
        include: path.resolve(ROOT_DIR, "src/vc_rust/assets"),
        type: "asset/resource",
        // use: [
        //   {
        //     loader: "file-loader",
