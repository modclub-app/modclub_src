...
export interface ModClub {
  ...
  getModeratorLeaderboard: (
    arg_0: bigint,
    arg_1: bigint
  ) => Promise<Array<ModeratorLeaderboard>>;
  ...
  submitChallengeData: (
    arg_0: PohChallengeSubmissionRequest
...
export interface PohUniqueToken {
  token: string;
}
...
export type ProviderRegisterResult = { ok: string } | { err: ProviderError };
...
export type Result_1 = { ok: PohTaskDataWrapperPlus } | { err: PohError };
