...
export interface Complexity { 'expiryTime' : Timestamp__1, 'level' : Level }
...
export interface Image { 'imageType' : string, 'data' : Uint8Array | number[] }
...
export interface ModClub {
  ...
  'airdropMigratedUser' : ActorMethod<[Principal], Result_2>,
  'airdropMigratedUsers' : ActorMethod<[], Result_2>,
  'appendMigrationAirdropItem' : ActorMethod<[Principal], Result_2>,
  'associateAccount' : ActorMethod<[string, ImportProfile, bigint], string>,
  'burn' : ActorMethod<[[] | [Subaccount], bigint], undefined>,
  'canClaimLockedReward' : ActorMethod<[[] | [Tokens]], Result_11>,
  'canReserveContent' : ActorMethod<[string], Result_2>,
  'checkIfUserOptToReciveAlerts' : ActorMethod<[], boolean>,
  'claimLockedReward' : ActorMethod<[Tokens, [] | [Principal]], Result_2>,
  'claimStakedTokens' : ActorMethod<[Tokens], Result_10>,
  'collectCanisterMetrics' : ActorMethod<[], undefined>,
  'configurePohForProvider' : ActorMethod<
    [Principal, Array<string>, bigint, boolean],
    undefined
  >,
  'createPohVoteReservation' : ActorMethod<[string], Result_9>,
  ...
  'getAirdropBalance' : ActorMethod<[], bigint>,
  ...
  'getImportedUsersStats' : ActorMethod<[], Result_8>,
  'getImportedUsersStatsByLevel' : ActorMethod<[UserLevel], string>,
  'getMigrationAirdropWhitelist' : ActorMethod<[], Result_7>,
  ...
  'reserveContent' : ActorMethod<[string], Result_4>,
  ...
  'setMigrationAirdropWhitelist' : ActorMethod<[Array<Principal>], Result_2>,
  ...
  'subscribeOnRsEvets' : ActorMethod<[], undefined>,
...
export type POHVoteError = { 'reservationExpire' : null } |
...
export type Result_10 = { 'ok' : bigint } |
  { 'err' : string };
export type Result_11 = { 'ok' : CanClaimLockedResponse } |
  { 'err' : string };
export type Result_2 = { 'ok' : boolean } |
  { 'err' : string };
export type Result_3 = { 'ok' : Array<PohChallengesAttempt> } |
  { 'err' : PohError };
export type Result_4 = { 'ok' : Reserved } |
  { 'err' : string };
export type Result_5 = { 'ok' : PohTaskDataAndVotesWrapperPlus } |
  { 'err' : PohError };
export type Result_6 = { 'ok' : PohTaskDataWrapperPlus } |
  { 'err' : PohError };
export type Result_7 = {
    'ok' : Array<[Principal, boolean, bigint, bigint, string]>
  } |
  { 'err' : string };
export type Result_8 = {
  ...
  { 'err' : string };
export type Result_9 = { 'ok' : Reserved } |
  { 'err' : POHVoteError };
export type Result__1 = { 'Ok' : TxIndex } |
  { 'Err' : TransferError };
...
export type UserLevel = { 'junior' : null } |
  ...
  { 'senior2' : null } |
  { 'senior3' : null };
export type UserLevel__1 = { 'junior' : null } |
  { 'novice' : null } |
  { 'senior1' : null } |
  { 'senior2' : null } |
  { 'senior3' : null };
...
export interface ViolatedRules { 'id' : RuleId, 'rejectionCount' : bigint }
export interface ViolatedRules__1 { 'ruleId' : string, 'ruleDesc' : string }
