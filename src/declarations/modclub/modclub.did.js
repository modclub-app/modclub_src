export const idlFactory = ({ IDL }) => {
  ...
  const Result_9 = IDL.Variant({ 'ok' : Reserved, 'err' : POHVoteError });
  ...
  const Result_7 = IDL.Variant({
    'ok' : IDL.Vec(
      IDL.Tuple(IDL.Principal, IDL.Bool, IDL.Nat, IDL.Nat, IDL.Text)
    ),
    'err' : IDL.Text,
  });
  ...
  const Result_4 = IDL.Variant({ 'ok' : Reserved, 'err' : IDL.Text });
  ...
  const ModClub = IDL.Service({
    ...
    'adminInit' : IDL.Func([], [], []),
    'adminUpdateEmail' : IDL.Func(
        [IDL.Principal, IDL.Text],
        [ProfileStable],
        [],
      ),
    'airdropMigratedUser' : IDL.Func([IDL.Principal], [Result_2], []),
    'airdropMigratedUsers' : IDL.Func([], [Result_2], []),
    'appendMigrationAirdropItem' : IDL.Func([IDL.Principal], [Result_2], []),
    ...
    'canClaimLockedReward' : IDL.Func([IDL.Opt(Tokens)], [Result_11], []),
    'canReserveContent' : IDL.Func([IDL.Text], [Result_2], []),
    ...
    'claimStakedTokens' : IDL.Func([Tokens], [Result_10], []),
    ...
    'createPohVoteReservation' : IDL.Func([IDL.Text], [Result_9], []),
    ...
    'getAirdropBalance' : IDL.Func([], [IDL.Nat], []),
    ...
    'getImportedUsersStats' : IDL.Func([], [Result_8], ['query']),
    'getImportedUsersStatsByLevel' : IDL.Func(
        [UserLevel],
        [IDL.Text],
        ['query'],
      ),
    'getMigrationAirdropWhitelist' : IDL.Func([], [Result_7], ['query']),
    ...
    'getPohTaskData' : IDL.Func([IDL.Text], [Result_6], ['query']),
    'getPohTaskDataForAdminUsers' : IDL.Func([IDL.Text], [Result_5], ['query']),
    ...
    'getProviderAdmins' : IDL.Func(
        [IDL.Principal],
        [IDL.Vec(ProfileStable)],
        [],
      ),
    ...
    'getReservedByContentId' : IDL.Func([IDL.Text], [Result_4], []),
    ...
    'reserveContent' : IDL.Func([IDL.Text], [Result_4], []),
    'resetUserChallengeAttempt' : IDL.Func([IDL.Text], [Result_3], []),
    'retiredDataCanisterIdForWriting' : IDL.Func([IDL.Text], [], ['oneway']),
    'retrieveChallengesForUser' : IDL.Func([IDL.Text], [Result_3], []),
    'sendVerificationEmail' : IDL.Func([IDL.Text], [IDL.Bool], []),
    'setLambdaToken' : IDL.Func([IDL.Text], [], []),
    'setMigrationAirdropWhitelist' : IDL.Func(
