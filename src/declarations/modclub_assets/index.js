...
import { idlFactory } from "./modclub_assets.did.js";
export { idlFactory } from "./modclub_assets.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MODCLUB_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./modclub_assets.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the modclub_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./modclub_assets.did.js")._SERVICE>}
*/
export const modclub_assets = createActor(canisterId);
