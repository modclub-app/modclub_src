...
import { idlFactory } from "./modclub_qa_assets.did.js";
export { idlFactory } from "./modclub_qa_assets.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MODCLUB_QA_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./modclub_qa_assets.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the modclub_qa_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./modclub_qa_assets.did.js")._SERVICE>}
*/
export const modclub_qa_assets = createActor(canisterId);
