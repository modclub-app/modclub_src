...
import { idlFactory } from "./modclub_qa.did.js";
export { idlFactory } from "./modclub_qa.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MODCLUB_QA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./modclub_qa.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the modclub_qa canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./modclub_qa.did.js")._SERVICE>}
*/
export const modclub_qa = createActor(canisterId);
