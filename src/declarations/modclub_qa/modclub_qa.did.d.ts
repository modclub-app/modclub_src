...
export interface ModClub {
  ...
  'canClaimLockedReward' : ActorMethod<[[] | [Tokens]], Result_8>,
  'canReserveContent' : ActorMethod<[string], Result_7>,
  'checkIfUserOptToReciveAlerts' : ActorMethod<[], boolean>,
  'claimLockedReward' : ActorMethod<[Tokens, [] | [Principal]], Result_7>,
  'claimStakedTokens' : ActorMethod<[Tokens], Result_6>,
  'collectCanisterMetrics' : ActorMethod<[], undefined>,
  'configurePohForProvider' : ActorMethod<
    [Principal, Array<string>, bigint, boolean],
    undefined
  >,
  'createPohVoteReservation' : ActorMethod<[string], Result_5>,
...
export type ReservedError = { 'userNotAllow' : null } |
...
export type Result_4 = { 'ok' : PohTaskDataWrapperPlus } |
  { 'err' : PohError };
export type Result_5 = { 'ok' : Reserved } |
  { 'err' : ReservedError };
export type Result_6 = { 'ok' : bigint } |
  { 'err' : string };
export type Result_7 = { 'ok' : boolean } |
  { 'err' : string };
export type Result_8 = { 'ok' : CanClaimLockedResponse } |
  { 'err' : string };
