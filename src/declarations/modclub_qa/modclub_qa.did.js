export const idlFactory = ({ IDL }) => {
  ...
  const ReservedError = IDL.Variant({
    'userNotAllow' : IDL.Null,
    'userAlreadyReserved' : IDL.Null,
  });
  const Result_5 = IDL.Variant({ 'ok' : Reserved, 'err' : ReservedError });
  ...
  const ModClub = IDL.Service({
    ...
    'canClaimLockedReward' : IDL.Func([IDL.Opt(Tokens)], [Result_8], []),
    'canReserveContent' : IDL.Func([IDL.Text], [Result_7], []),
    ...
    'claimStakedTokens' : IDL.Func([Tokens], [Result_6], []),
    ...
    'createPohVoteReservation' : IDL.Func([IDL.Text], [Result_5], []),
