...
export type ENV = { 'qa' : null } |
  ...
  { 'prod' : null } |
  { 'local' : string };
export interface RSAndLevel { 'level' : UserLevel, 'score' : number }
...
export type Result_1 = { 'ok' : Array<Principal> } |
  { 'err' : string };
export interface UserAndRS { 'userId' : Principal, 'score' : number }
export interface UserAndVote { 'votedCorrect' : boolean, 'userId' : Principal }
