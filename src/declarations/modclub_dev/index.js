...
import { idlFactory } from "./modclub_dev.did.js";
export { idlFactory } from "./modclub_dev.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MODCLUB_DEV_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./modclub_dev.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the modclub_dev canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./modclub_dev.did.js")._SERVICE>}
*/
export const modclub_dev = createActor(canisterId);
