...
module {
  ...
  public func getAccountIdentifierFromAccountIndex(principal : Principal, subaccountIndex : SubaccountIndex) : AccountIdentifier {
  ...
  public func getSubAccountIdentifierFromAccountIndex ( principal : Principal,subaccountIndex : SubaccountIndex) : Blob {
    ...
    // Counter as Nonce
    let idBytes = beBytes(subaccountIndex);
