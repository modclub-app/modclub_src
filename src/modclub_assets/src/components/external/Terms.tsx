...
export default function Terms() {
  return (
    <div className="landing-page info has-background-black has-text-silver pb-6">
      ...
      <Section>
        <Container>
          <p className="mb-4">This page explains the terms by which you may use the websites and Company Content (as defined below) of Modclub Foundation (<span className="has-text-white has-text-weight-bold">“we”</span>, <span className="has-text-white has-text-weight-bold">“our”</span> and <span className="has-text-white has-text-weight-bold">“us”</span>), including without limitation modclub.app (collectively, the <span className="has-text-white has-text-weight-bold">“Sites”</span>) and our Services (as defined below). By accessing or using the Sites or the Services, you signify on your behalf and any person or entity that you represent that you have read, understood, and agree to be bound by these Terms of Service (the <span className="has-text-white has-text-weight-bold">“Agreement”</span>), whether or not you are a registered user of our Sites or the Services. We reserve the right to make unilateral modifications to these terms and will provide notice of these changes as described below. This Agreement applies to all visitors, users, and others who access the Sites or the Services (<span className="has-text-white has-text-weight-bold">“you”</span> and <span className="has-text-white has-text-weight-bold">“your”</span>).</p>
      ...
      <Section>
        <Container>
          ...
          <p>As part of the Sites, we provide access to, among other services, the MODCLUB platform (the <span className="has-text-white has-text-weight-bold">“Platform”</span>). This Agreement governs your use of our Sites, the Platform, and all related tools, applications, data, software and other services provided by us (collectively, the <span className="has-text-white has-text-weight-bold">“Services”</span>).</p>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          ...
          <ul style={{ listStyle: "disc" }}>
            ...
            <li>are not prohibited from entering or using this Sites or the Services or transacting with the Platform under any Applicable Laws;</li>
            <li>understand the risks associated with using our Sites and the Services, including using the Platform; and</li>
            <li>understand that you will be dealing with third parties and we have not verified and will not be in a position to verify any transaction you make using the Platform.</li>
          </ul>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          ...
          <p className="mb-4">You are solely responsible for your interactions with other users of the Sites and the Services. We reserve the right, but have no obligation, to monitor disputes between you and other users. We shall have no liability for your interactions with other users, or for any user's action or inaction.</p>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          <Heading subtitle>
            Sites Location; Restrictions on Use
          </Heading>
          <p>The Sites are controlled and operated from facilities in Panama. We make no representations that the Sites or the Services are appropriate or available for use in other locations. Those who access or use the Sites or the Services from other jurisdictions do so at their own volition and are entirely responsible for compliance with all Applicable Laws, including but not limited to export and import regulations. <span className="has-text-white has-text-weight-bold">You may not use the Sites or the Services if you are a person or entity resident in, a citizen of, located in, incorporated, formed or organized in or have a registered office in (i) a country embargoed by the government of Canada, the United States, the United Kingdom or the European Union or are a foreign person or entity blocked or denied by the Canadian, United States, the United Kingdom or any European Union government or (ii) a country which has been sanctioned by the United Nations (any such person or entity being a “Restricted Person”).</span> Unless otherwise explicitly stated, all materials found on the Sites and the Services are solely directed to individuals, companies, or other entities located in Panama.</p>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          ...
          <p>We care about the privacy of our users. You understand that by using the Sites you consent to the collection, use and disclosure of personally identifiable information and aggregate data, and to have your personally identifiable information collected, used, transferred to and processed in accordance with our Privacy Policy, a copy of which can be found <Link to="/privacy">here</Link>. Our Privacy Policy is hereby incorporated into and forms part of this Agreement.</p>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          ...
          <p className="mb-4">We are an early stage platform. You acknowledge that applications are code that are subject to flaws and acknowledge that you are solely responsible for evaluating any available code provided by the Services. You further expressly acknowledge and represent that applications can be written maliciously or negligently, and that we cannot be held liable for your interaction with such applications. These warnings and others later provided by us in no way evidence or represent an ongoing duty to alert you to all the potential risks of utilizing the Sites and Services.</p>
          <p>We use commercially reasonable physical, managerial, and technical safeguards to preserve the integrity and security of your personal information and implement your privacy settings. However, we cannot guarantee that unauthorized third parties will never be able to defeat our security measures or use your personal information for improper purposes. You acknowledge that you provide your personal information at your own risk.</p>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          ...
          <p>You agree to defend, indemnify and hold harmless us and our suppliers, partners, licensors, dealers, representatives, associates or affiliates, and each of their respective employees, contractors, agents, representatives, shareholders, officers and directors (collectively, the <span className="has-text-white has-text-weight-bold">“Company Parties”</span>), from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to lawyer’s fees and disbursements) arising from: (a) your use of and access to the Sites, Company Content and the Services, including any act or omission by you or users of your account or any data or content transmitted or received by you; (b) your violation of any term of this Agreement, including without limitation your breach of any of the representations and warranties above; (c) your violation of any third-party right, including without limitation any right of privacy or intellectual property rights; (d) your violation of any Applicable Laws; (e) any User Content that you submit to the Sites or the Services including without limitation misleading, false, or inaccurate information; (f) your willful misconduct; or (g) any other party’s access and use of the Sites, Company Content or the Services with your unique username, password or other appropriate security code. You will co-operate as fully as reasonably required in the defense of any claim.</p>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          ...
          <p>This limitation of liability section applies whether the alleged liability is based on contract, tort, negligence, strict liability, or any other basis, even if we have been advised of the possibility of such damage. The foregoing limitation of liability shall apply to the fullest extent permitted by Applicable Laws.</p>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          <Heading subtitle>
            Exclusions Fundamental to this Agreement
          </Heading>
          <p>The disclaimers of warranties and limitations of liability set forth in this Agreement are fundamental elements of the basis of the agreement between you and us. You understand and agree that we would not be able to economically or reasonably provide the Services to you without these limitations.</p>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          ...
          <p>This Agreement is entered into in the Republic of Panama and shall be governed by, and construed in accordance with, the laws of the Republic of Panama. You agree to submit to the exclusive jurisdiction of the courts of the Republic of Panama or any other judicial district or jurisdiction as we may determine in any and all actions, disputes or controversies relating hereto. You further agree as follows: (a) any claim brought to enforce this Agreement must be commenced within 2 years of the cause of action accruing; (b) no recovery may be sought or received for damages other than out-of-pocket expenses, except that the prevailing party will be entitled to costs and legal fees; (c) your sole and exclusive remedy shall be for monetary damages only and you hereby waive all rights to equitable remedies; and (d) any claim must be brought individually and not consolidated as part of a group or class action complaint.</p>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          ...
          <p>We reserve the right, in our sole discretion, to modify the terms of this Agreement from time to time. If we make changes, we will provide you with notice of such changes, such as by providing notice through the Sites, the Services or updating the “Last Updated” date at the top of this Agreement. Unless we state otherwise in our notice, all such modifications are effective immediately, and your continued use of the Sites and the Services after we provide that notice will confirm your acceptance of the changes. If you do not agree to the amended terms of this Agreement, then your only recourse is to terminate this Agreement by providing written notice to us and must stop using the Sites and the Services.</p>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          ...
          <p>This Agreement, including all other documents incorporated by reference herein, are binding and constitute the entire agreement between us and you with respect to your use of the Sites and the Services.</p>
        </Container>
      </Section>
      ...
      <Section className="mb-6">
        <Container>
          ...
          <p>The parties agree that the English language will be the language of the Agreement and all documents in connection thereto, and each party waives any right (whether statutory or otherwise) to use and rely upon any other language, or translations. <span className="is-italic">Il est de la volonté expresse des parties que tous les documents qui s'y rattachent soient rédigés en langue anglaise.</span></p>
        </Container>
      </Section>
    </div>
  )
