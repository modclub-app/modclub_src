export const NOVICE_LEVEL_UPGRADE_MESSAGE = "Reach 20 scores to level up to Junior moderator";
export const JUNIOR_LEVEL_UPGRADE_MESSAGE = "Reach 50 scores to level up to Senior moderator";
export const SENIOR_MODERATOR_MESSAGE = "You are now senior";
export const DEFAULT_MESSAGE = "...";
export const NOVICE_CLAIM_LIMIT_MESSAGE = "Upgrade to Junior moderator to start claiming your rewards";
