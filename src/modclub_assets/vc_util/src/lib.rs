...
pub fn get_verified_id_alias_from_jws(
    ...
    println!(
        "*** [DEBUG] [get_verified_id_alias_from_jws] [STARTED_FOR]:: {:?}",
        &signing_canister_id
    );
    ...
    println!(
        "*** [DEBUG] [get_verified_id_alias_from_jws] [CLAIMS]:: {:?}",
        &claims
    );
...
pub fn verify_credential_jws_with_canister_id(
    ...
    println!(
        "\n*** [DEBUG] [verify_credential_jws_with_canister_id] [Decode JWS STARTED]:: {:?}\n",
        &signing_canister_id
    );
    ///// Decode JWS.
