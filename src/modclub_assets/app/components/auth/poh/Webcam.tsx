  ...
  return !file.data ? (
    ...
    >
      <div style={{ paddingBottom: "75%" }}>
        ...
        {!loading && (
          <>
            <CaptureButton icon="photo_camera" handleClick={captureWebcam} />
            <Button
              renderAs="a"
              rounded
              style={{
    ...
    <div className="is-relative has-text-centered">
      {file.cropped || !showCrop ? (
        <div
          style={{
            ...
            maxHeight: 480,
            margin: "auto",
            background: `url(${file.data}) no-repeat center`,
      ...
      {!file.uploaded && <SaveButton file={file} />}
      <CaptureButton icon="delete" handleClick={clearImage} />
      {croppedAreaPixels && (
        <Button
          renderAs="a"
          rounded
