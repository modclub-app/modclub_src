...
export default function SectionFive() {
  return (
    <section
      className={`py-40 md:py-72 px-14 md:px-40 ${Styles.sectionFive} w-full`}
    >
                    ...
                    <>
                      ...
                      >
                        <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                          ...
                          <p>
                            To learn more about Modclub&#39;s tokenomics model read our {" "}
                            <Link
                              target="_blank"
                  ...
                  {({ open }) => (
                    <>
                      ...
                      >
                        <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                          <p>
                            Join Modclub&#39;s community moderators and help
                    ...
                    <>
                      ...
                      >
                        <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                          ...
                          <ul>
                            <li>
                              Modclub&#39;s platform combines AI capabilities
                              with human-powered decentralized moderation
                              services. Our AI algorithms help identify and
                              address potential issues in user-generated
                              content, while our community of moderators
                              provides the human touch necessary to maintain the
                              quality and integrity of your platform.
                            </li>
                          </ul>

                          <p>
                            What types of platforms can benefit from
                            Modclub&#39;s services?
                          </p>
                          <ul>
                            <li>
                              ...
                              platforms, online marketplaces, community forums,
                              and any platform that deals with user-generated
                              content.
                            </li>
                          </ul>

                          <p>
                            How can Modclub help protect my brand reputation?
                          </p>
                          <ul>
                            <li>
                              By utilizing Modclub&#39;s content moderation
                              platform, you can ensure that your platform is
                              moderated in a fair and unbiased manner,
                              protecting your brand reputation by maintaining
                              high-quality content and fostering user trust.
                            </li>
                          </ul>

                          <p>
                            Is Modclub&#39;s moderation process customizable?
                          </p>
                          <ul>
                            <li>
                              Yes, Modclub offers customizable moderation rules
                              and parameters to meet your platform&#39;s
                              specific needs. Tailor the level of scrutiny,
                              number of votes required, and rewards given to
                              moderators to align with your unique requirements.
                            </li>
                          </ul>
                          ...
                          <ul>
                            <li>
                              Modclub prioritizes the privacy and security of
                              user data. Our platform adheres to strict data
                              protection protocols and follows industry best
                              practices to ensure the confidentiality,
                            ...
                            <li>
                              Users signing up for Modclub platform as
                              moderators have to undergo a Proof of Humanity
                              process. Data collected in the Proof of Humanity
                              process will be deleted after a grace period of
                              approximately 5 days to ensure users data privacy.
                            </li>
                          </ul>

                          <p>
                            What sets Modclub apart from other content
                          ...
                          <ul>
                            <li>
                              ...
                              algorithms identify potential content issues,
                              while experienced human moderators provide the
                              judgment and context necessary to maintain the
                              quality and integrity of your platform.
                              Modclub&#39;s platform is highly customizable to
                              suit your platform&#39;s unique needs, ensuring
                              seamless alignment with your objectives and
                              values.
                            </li>
                          </ul>
                          ...
                          <ul>
                            <li>
                              ...
                              website and sign up for an account. From there,
                              you can explore our platform, customize your
                              moderation parameters, and begin your journey
                              towards efficient and effective content
                              moderation. Reach out to us for access to our
                              easy-to-use developer SDK.
                            </li>
                          </ul>
                          ...
                          <ul>
                            <li>
                              ...
                              you can start moderating content and earn MOD
                              tokens based on your contributions, performance,
                              and reputation score.
                            </li>
                            <li>
                              Join Modclub&#39;s community of moderators and
